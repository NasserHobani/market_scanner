    ...
    Group(
        ...
        fields=(
            ...
            Field("sync_timeframes", "فريمات المزامنة لكل سوق", "text", "",
                  ...
                  "مُشبَعٍ أصلاً.\n\n"
                  "وأكثرها لا يُستعمل: المسح يقرأ ‎4h‎، والتحليل من "
                  "الأعلى للأسفل يقرأ ‎4h‎ و‎1d‎. و‎15m‎ لا تدخل إلّا "
                  "في توقيت الالتقاء — تحسينٌ لا شرط.\n\n"
                  "الصيغة: سوق=فريمات، مفصولةً بفواصل، والأسواق "
                  "بسطرٍ أو نقطة:\n"
                  "    crypto=4h,1d\n"
                  "    saudi=1d\n"
                  "    gold=4h,1d\n\n"
                  "والسوق غير المذكور يبقى على الأربعة. وفريم المسح "
                  "المضبوط في ملفّ السوق يُضاف دائماً ولو لم يُذكر — "
                  "إسقاطه يعني سوقاً يُزامَن ولا يُمسَح، بلا خطأ ولا "
                  "صفر نتائج."),
        ),
    ),
    Group(
