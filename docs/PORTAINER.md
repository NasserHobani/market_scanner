...
**الحاويات تتوقّف فوراً والسجلّ يقول «متغيّرات ناقصة»** — لم تصل
المتغيّرات. تحقّق في بورتينر: الـStack ← `Environment variables`
— يجب أن تراها **مدرَجةً اسماً وقيمة**. وإن استعملت
`Advanced mode` للّصق فاضغط زرّ العودة إلى الوضع البسيط قبل
الحفظ، وتأكّد أنّها ظهرت في الجدول. ثمّ `Update the stack`.
